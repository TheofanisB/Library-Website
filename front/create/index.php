						...
						<div class="col-12 col-md-10 d-none d-xl-block">
							<nav class="site-navigation position-relative text-right" role="navigation">
								...
								<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
									...
									<ul class="dropdown">
											<li><a href="add_author.php">Add an Author</a></li>
											<li><a href="delete_author.php">Delete an Author</a></li>
									...
									<li  ><a href="stats.php" class="nav-link">Stats</a></li>
									<li id="username_label" ><a href="logout.php" class="nav-link">Log-Out</a></li>
									
									
									<!-- OTAN EXEI KANEI LOG IN TOTE ANTI LOGIN NA EMFANIZEI TO ONOMA TOU XRISTI 
										<?php
										...
										$('#username_label').html('<a href="logout.php" class="nav-link">Logout</a>');
										</script>
						...
						<div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
							...
							<div class="row justify-content-center mb-4">
								<div class="col-md-8 text-center">
									...
									<div><a data-fancybox data-ratio="2" href="https://youtu.be/TR831EYWwWA" class="btn btn-primary btn-md">Watch Video</a></div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-4">
							<div class="p-3 box-with-humber">
								...
								<p class="mb-4">You can browse and manage the announcements through the announcements tab at the top.</p>
								<ul class="list-unstyled ul-check primary">
									<li>Search an Announcement</li>
									<li>Add an Announcement</li>
									<li>Delete an Announcement</li>
									<li>Modify an Announcement</li>
									<li>Import/Export Announcements</li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-6 col-lg-4">
							<div class="p-3 box-with-humber">
								...
								<p class="mb-4">You can manage the authors through the authors tab at the top.</p>
								<ul class="list-unstyled ul-check primary">
									<li>Add an Author</li>
						...
						<div class="col-md-6 col-lg-4">
							<div class="p-3 box-with-humber">
								...
								<p class="mb-4">You can browse through the stats by clicking the Stats tab at the top if the page. </p>
								<ul class="list-unstyled ul-check primary">
									<li>Announcements per Year</li>
									<li>Duration Chart</li>
									<li>Location Chart</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-md-6 order-md-1" data-aos="fade">
							...
							<div class="row">
								...
								<div class="col-12 mb-4">
									<p class="lead">ΠΑΝΕΠΙΣΤΗΜΙΟ ΑΙΓΑΙΟΥ, Τμήμα Μηχανικών Πληροφοριακών και Επικοινωνιακών Συστημάτων, Καρλόβασι, 83200 Σάμος</p>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-5">
							...
							<div class="p-4 mb-3 bg-white">
								...
								<p class="mb-4">Κτήριο Λυμπέρη, Παλαμά 2 &Γοργύρας </p>
								
								<p class="mb-0 font-weight-bold">Phone</p>
								<p class="mb-4"><a href="#">+2273082200</a></p>
								
								<p class="mb-0 font-weight-bold">Email Address</p>
								<p class="mb-0"><a href="#">dicsd@aegean.gr</a></p>
