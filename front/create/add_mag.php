					...
					<div class="d-flex justify-content-center">
							...
							<div class="d-flex justify-content-center">
								...
								<div class="comment-form-wrap pt-5">
									...
									<form action="add_mag_plugin.php"  method="post"  class="bg-light p-5 contact-form">
										...
										<div class="form-group">
											<label for="m_url">Magazine Url</label>
											<input type="text" class="form-control" name="m_url" id="m_url">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="pages" class="form-control" name="pages" id="pages">
										</div>
