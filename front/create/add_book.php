...
<!--//IPOSELIDA GIA NA PROSTHESEI ENA VIVLIO STIN VASI . OTAN PATAEI TO KOUMPI PROSTHIKIS THA PREPEI NA TON PETAEI STO ADD_BOOK_PLUGIN -->
					...
					<div class="d-flex justify-content-center">
						...
						<div class="d-flex justify-content-center">
							...
							<div class="comment-form-wrap pt-5">
								...
								<form action="add_book_plugin.php"  method="post"  class="bg-light p-5 contact-form">
									...
									<div class="form-group">
										<label for="b_url">Book URL</label>
									...
									<div class="form-group">
										<label for="address">Address of Publisher</label>
									...
									<div class="form-group">
										<input type="submit" value="ADD BOOK" class="btn btn-primary btn-md text-white">
									</div>
