...
<!-- selida stin opoia tha ginetai diagrafi kapoias anakoinosis  pou iparxei stin vasi me tin voithia kapoiou plugin me vasi ta stoixeia pou tha simplirosei o xristis  -->
<html lang="en">
	<head>
								...
								<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
									...
									<li class="has-children">
										...
										<ul class="dropdown">
											...
											<li class="nav-item active"><a href="delete.php">Delete an Announcement</a></li>
					...
					<div class="d-flex justify-content-center">
						...
						<div class="d-flex justify-content-center">
							...
							<div class="comment-form-wrap pt-5">
								<h3 class="d-flex justify-content-center">Delete Announcements</h3>
								
								
								<form action="delete_plugin.php"  method="post"  class="bg-light p-5 contact-form">
									...
									<p>
										...
										<div class="form-group">
											<input type="submit" value="DELETE" class="btn btn-primary btn-md text-white">
										</div>
