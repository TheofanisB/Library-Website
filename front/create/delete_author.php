...
<!--SELIDA POU THA GINEI PROSTHIKI ANNOUNCEMENT TIPOU OTHER STIN VASI . XRISIMOPOIEI TO ADD_OTHER_PLUGIN GIA NA TO PETIXEI -->
								...
								<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
									...
									<li class="has-children">
										...
										<ul class="dropdown">
											...
											<li><a  class="nav-item active" href="delete_author.php">Delete an Author</a></li>
					...
					<div class="d-flex justify-content-center">
						...
						<div class="d-flex justify-content-center">
							...
							<div class="comment-form-wrap pt-5">
								...
								<form action="delete_author_plugin.php"  method="post"  class="bg-light p-5 contact-form">
									<div>
