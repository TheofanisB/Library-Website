...
<!--SELIDA OPOU O XRISTIS THA KANEI LOGIN STIN SELIDA  -->
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-11 col-xl-2">
							<h1 class="mb-0 site-logo"><a href="login.php" class="text-black h2 mb-0">ICSD<span class="text-primary">.</span> </a></h1>
						</div>
						<div class="col-12 col-md-10 d-none d-xl-block">
							<nav class="site-navigation position-relative text-right" role="navigation">
								...
								<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
									...
									<div class="card-body">
										<form name="formamou" method="post" class="row row-list">
											<div style="float: left;" >
												
												<input type="text" name="username" id="username" value="" placeholder="User Name"  class="form-control mr-3">
											</div>
											...
											<div style="float: center;">
												<button class="btn btn-success  d-flex justify-content-center ml-5" name="Login" formaction="login_plugin.php">Login</button>
											</div>
											
											<div style="float: center;">
											<a>
												<button class="btn btn-info  d-flex justify-content-center ml-1; submit_button" name="Register" formaction="register.php">Register</button>
											</div>
											<div style="float: center;">
												<button class="btn btn-info d-flex justify-content-center ml-1" name="Guest" formaction="login_plugin.php">Guest</button>
