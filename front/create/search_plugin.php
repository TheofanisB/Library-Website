							...
							<nav class="site-navigation position-relative text-right" role="navigation">
								...
								<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
									...
									<li class="has-children">
										...
										<ul class="dropdown">
											<li  class="nav-item active"><a href="search.php">Search an Announcement</a></li>
								...
								<form name="forma"  method="post"  class="bg-light p-5 contact-form">
									...
									<center>
										<div class="form-group">
											<input type="submit" value="DELETE" class="btn btn-primary btn-md text-white" onclick="forma.action='delete_plugin.php'">
											<input type="submit" value="MODIFY" class="btn btn-primary btn-md text-white" onclick="forma.action='update_plugin.php'">
										</div>
									</center>
								</form>
